...
async def get_recent_announcements(
    ...
    try:
        ...
        response_data = []
        for a in announcements:
            # Convert announcement_data to dict if it's a Pydantic model
            if hasattr(a.announcement_data, 'model_dump'):
                announcement_data_dict = a.announcement_data.model_dump(mode='json')
            elif hasattr(a.announcement_data, 'dict'):
                announcement_data_dict = a.announcement_data.dict()
            ...
            response_data.append(AnnouncementResponseSchema(
                id=str(a.id),
                announcement_data=announcement_data_dict,
                source_url=a.source_url,
                is_active=a.is_active,
...
async def get_announcement(
    ...
    try:
        ...
        elif hasattr(announcement.announcement_data, 'dict'):
            announcement_data_dict = announcement.announcement_data.dict()
        else:
            announcement_data_dict = dict(announcement.announcement_data)
